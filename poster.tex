...
%{
  \begin{center}
   ...
   % Titel und Autor
    {\huge \textbf{Übersicht über Schaltbare Spiegel}\\}%[0.03\textheight]
  ...
  \begin{picture}(0,0)
    ...
    \put(0.0  , 3.1){\large \textsf{\textbf{Funktionswerkstoffe der Elektrotechnik}}}
    \put(0.0  , 1.75){\large \textsf{\textbf{Prof. Dr.-Ing. Ronald Plath}}}
    \put(0.0  , 0.4){\large \textsf{\textbf{Prof. Dr. rer. nat. Bernd Szyszka}}}
  \end{picture}
%}
